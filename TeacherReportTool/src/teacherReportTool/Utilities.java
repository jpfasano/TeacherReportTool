...
public class Utilities {
    ...
    public static InputStream getResourceInputStream(String resourceName) {
        ...
        try {
            ...
            if (retVal == null) {
                retVal = classLoader.getResourceAsStream("/TeacherReportTool/TeacherReportTool/resources/" + resourceName);
            }
            if (retVal == null) {
                retVal = classLoader.getResourceAsStream("TeacherReportToolTeacherReportTool/resources/" + resourceName);
            }
