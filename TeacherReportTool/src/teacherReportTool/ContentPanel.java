...
public class ContentPanel extends JPanel {
   ...
   // Constructor that creates a new content panel from priorContentPanel except
   // for SentenceTemplates which are new.
   public ContentPanel(TeacherReportTool trt, ContentPanel priorContentPanel) {
      super();
      gutsOfContentPanelConstructor(trt, priorContentPanel.studentPanel, new TemplatePanel(trt),
            priorContentPanel.editableTextPanel);

   }

   private void gutsOfContentPanelConstructor(TeacherReportTool trt, StudentPanel sp, TemplatePanel tp,
      ...
      // There are 3 parts to the content panel: Students, Templates, and
      // Editable text.
