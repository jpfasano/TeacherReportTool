...
{
  private ArrayList<TemplatePanel> templatePanels = new ArrayList<TemplatePanel>();
  ...
  public TabbedTemplatePanel(TeacherReportAssistant tra)
  {
    ...
    for (TemplateCategory tc: templates)
    {
      ...
      TemplatePanel tpl = new TemplatePanel(tra,tc);
      templatePanels.add(tpl);
      

      //p.add(tpl,gbc);
      
      jTabbedPane.add(new JScrollPane(tpl),tc.getName());
    }
  ...
  {
    for (TemplatePanel tp : templatePanels)
